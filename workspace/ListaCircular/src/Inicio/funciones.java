...
public class funciones{
    ...
    public static void main(String args[]){
        ...
        do{
        	desicion = (String)JOptionPane.showInputDialog(null,"señor usuario que desea hacer", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opciones, opciones[0]);
            switch (desicion) {            
            	case "modificar":
            		if (lista.estavacio()==false){
            			String opcionesModificar[]={"normal","bloque"},desicionModificar;
            			desicionModificar = (String)JOptionPane.showInputDialog(null,"señor usuario que desea hacer", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opcionesModificar, opcionesModificar[0]);
            			if (desicionModificar.equals("normal")){
                			...
                			desicionModificarCriterio = (String)JOptionPane.showInputDialog(null,"Seleccione el criterio de busqueda", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opcionesModificarCriterio, opcionesModificarCriterio[0]);
            	...
            	case "eliminar":
            		...
            		desicionEliminar = (String)JOptionPane.showInputDialog(null,"señor usuario que desea hacer", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opcionesEliminar, opcionesEliminar[0]);
            	...
            	case "insertar":
            		...
            		if (desicionInsertar.equals("Insertar en la cola")){
            			...
            			ingresarDatos();
                        lista.insercabeza(identificacion,nombre,apellido,nota1,nota2,nota3,notadefinitiva);
            		}
                ...
                case "desplegar lista":
                	String opcionesLista[]={"acendente","Decendente"},desicionLista;
            		desicionLista = (String)JOptionPane.showInputDialog(null,"señor usuario como desea ver los datos", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opcionesLista, opcionesLista[0]);
                	if (desicionLista.equals("acendente")){
            			if (lista.estavacio()==false){
                		lista.despliegaLista();}
                		else{
                	...
                	else if (desicionLista.equals("Decendente")){
            			if (lista.estavacio()==false){
                    		lista.desplegarDecendente();}
                    		else{
                    			JOptionPane.showMessageDialog(null, "no hay datos");
                    		}
                ...
                case "buscar":                	
            		if (lista.estavacio()==false){
                		...
                		desicionBuscar = (String)JOptionPane.showInputDialog(null,"señor usuario que desea hacer", "lista doble",JOptionPane.INFORMATION_MESSAGE,null,opcionesBuscar, opcionesBuscar[0]);
