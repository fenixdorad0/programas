	...
	if(aux == null){
	   ...
	   if(aux==null){
		...
		if (cont>0){
		    ...
		    switch (desicion) {
		       	case "todo":				   
		       		id = AppLista.leer_entero("Digite el nuevo numero de identificación ");
		            ...
		            not1=AppLista.leer_nota("Digite la nueva nota 1 de "+nomb+" "+apelli);
		            not2=AppLista.leer_nota("Digite la nueva nota 2 de "+nomb+" "+apelli);
		            not3=AppLista.leer_nota("Digite la nueva nota 3 de "+nomb+" "+apelli);
		        ...
		        case "apellido":
		           	...
		           	break;
		        case "notas":
		        	not1=AppLista.leer_nota("Digite la nueva nota 1 de "+aux.nomb+" "+aux.apelli);
	                not2=AppLista.leer_nota("Digite la nueva nota 2 de "+aux.nomb+" "+aux.apelli);
	                not3=AppLista.leer_nota("Digite la nueva nota 3 de "+aux.nomb+" "+aux.apelli);
	                notf=(not1*0.3)+(not2*0.3)+(not3*0.4);
...
public void buscarNotas(int notMin, int notMax) {
	...
	String desicionNotas = (String)JOptionPane.showInputDialog(null,"señor usuario que desea modificar", "lista simple",JOptionPane.INFORMATION_MESSAGE,null,opcionesNotas, opcionesNotas[0]);
...
//error corregido *
//23/09/16 modificar,modificar por bloques terminado proyecto eliminar por bloques iniciado
